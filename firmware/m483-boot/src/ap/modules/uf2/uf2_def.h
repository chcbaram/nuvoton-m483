 ...
 * Board / UF2 identity
 *-------------------------------------------------------------------------*/
#define UF2_PRODUCT_NAME          "WISH-BOOT"
#define UF2_BOARD_ID              "WISH-8K"
#define UF2_VOLUME_LABEL          "WISH-BOOT"          /* FAT12 volume label (<=11) */
#define UF2_INDEX_URL             "https://github.com/"

/* BOARD_UF2_FAMILY_ID, BOARD_FLASH_APP_START come from hw_def.h. */


/*---------------------------------------------------------------------------
 * Deterministic compile date/time -> DOS date/time for the FAT directory.
 *-------------------------------------------------------------------------*/
#ifndef COMPILE_DATE
